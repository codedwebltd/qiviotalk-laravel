...
(function () {
  ...
  const icons = {
    ...
    headset: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="24" height="24" fill="currentColor"><path d="M256 48C141.1 48 48 141.1 48 256v96c0 26.5 21.5 48 48 48h32c0 35.3-28.7 64-64 64v32c53 0 96-43 96-96V112c0-8.8-7.2-16-16-16H112c-8.8 0-16 7.2-16 16v240c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16v-64c0-17.7 14.3-32 32-32h128c17.7 0 32 14.3 32 32v64c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16V112c0-8.8-7.2-16-16-16h-32c-8.8 0-16 7.2-16 16v240c0 8.8 7.2 16 16 16h32c26.5 0 48-21.5 48-48v-96c0-114.9-93.1-208-208-208z"/></svg>`,
    ...
    'concierge-bell': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="24" height="24" fill="currentColor"><path d="M480 272h-96c0-42.5-16.7-82.2-46.7-112.3-30.1-30-69.8-46.7-112.3-46.7-87.9 0-159 71.1-159 159v15.7c-9.2 7.9-25.3 21.4-36 30.9V400c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48v-80c0-26.5-21.5-48-48-48zM32 224c0 40.3 18.5 75.5 45.9 102.1-12.7 8.1-23.1 14.8-30.3 19.5-10.9 7.1-17.6 19.1-17.6 32.1V416c0 17.7 14.3 32 32 32h384c17.7 0 32-14.3 32-32v-38.3c0-12.5-5.8-24.2-15.7-31.8-5.9-4.5-14.9-11.1-25.9-19.1 25-26.3 43.6-61.3 43.6-102.8 0-25.2-6.3-48.8-17.5-69.5 4.9-1.6 9.8-3.3 14.7-5.1 18-6.8 30.8-24.1 30.8-44.5 0-17.7-14.3-32-32-32-4.1 0-8 .7-11.6 2.1-12.6-35.8-40.2-65-75.3-80.2 1.7-5.5 2.9-11.2 2.9-17.3 0-26.5-21.5-48-48-48-11.9 0-22.7 4.4-31.1 11.6C295.3 11.7 272.7 0 248 0c-83.6 0-141.3 67.9-149.6 129.8-14.3 3.5-25.9 13.1-31.5 26.3-16.9 5.4-30 20-34.8 37.1-32 .4-58.9 24.7-63.6 56.1-5.6.9-10.9 2.4-16.5 4.2v-29.5z"/></svg>`,
...
@keyframes typingAnimation {
  ...
  const api = {
    ...
    updateVisitorEmail: async (email) => {
      try {
  ...
  const createChatWindow = () => {
    ...
    emailForm.innerHTML = `
      <p>Share your email to receive notifications about replies:</p>
  ...
  const renderMessages = (messagesContainer, messages) => {
    ...
    setTimeout(() => {
      ...
      <div style="display: flex;">
        <input type="email" class="livechat-email-input" placeholder="your@email.com" style="flex: 1; margin-right: 8px;">
        <button class="livechat-email-submit">Submit</button>
      </div>
    `;
        ...
        submitButton.addEventListener('click', async () => {
          ...
          try {
            // Update visitor email
            const success = await api.updateVisitorEmail(email);
  ...
  channel.bind('new-message', function(data) {
    ...
    if (data.sender_type !== 'visitor') {
      ...
      if (!messageExists) {
        ...
        // Update UI if messages container exists
        const messagesContainer = chatWindow.querySelector('.livechat-messages');
        if (messagesContainer) {
